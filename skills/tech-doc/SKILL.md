...
### 실행
- Explore 에이전트로 분석 (병렬 가능: FE/BE 동시)
- 문서 유형에 따라 분석 항목 결정:
...
독립 문서 여러 개 동시 작성 시:
1. Phase 1: Explore 에이전트 병렬 (FE/BE 분석)
2. Phase 3: Agent 도구로 문서별 병렬 작성 (`references/agent-guide.md` 참조)
3. Phase 4: Reviewer 에이전트로 검증
